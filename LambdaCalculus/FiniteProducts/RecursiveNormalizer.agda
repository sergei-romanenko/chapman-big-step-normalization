module FiniteProducts.RecursiveNormalizer where
...
mutual
  ...
  ... | w₁~w₂
    ...
    = w₁~w₂
  ~cong⟦⟧ {t₁ = (f ∙ a) [ σ ]} ≈∙[] {ρ₁} {ρ₂} ρ₁~~ρ₂
    with ~~cong⟦≡⟧* σ ρ₁~~ρ₂
  ... | θ₁~~θ₂
    with ~cong⟦≡⟧ a θ₁~~θ₂
  ... | v₁~v₂
    with ~cong⟦≡⟧ f θ₁~~θ₂ ≤id v₁~v₂
  ... | w₁~w₂
    rewrite val≤ ≤id (⟦ f ⟧ (⟦ σ ⟧* ρ₁)) ≡ ⟦ f ⟧ (⟦ σ ⟧* ρ₁) ∋ val≤-≤id _ |
            val≤ ≤id (⟦ f ⟧ (⟦ σ ⟧* ρ₂)) ≡ ⟦ f ⟧ (⟦ σ ⟧* ρ₂) ∋ val≤-≤id _
    = w₁~w₂
  ~cong⟦⟧ {t₁ = (ƛ t) [ σ ] ∙ a} ≈βσ {ρ₁} {ρ₂} ρ₁~~ρ₂ =
    ~cong⟦≡⟧ t (~cong⟦≡⟧ a ρ₁~~ρ₂ ∷ ~~cong⟦≡⟧* σ ρ₁~~ρ₂)
  ...
  ~~cong⟦⟧* {σ₁ = ↑ ○ (t ∷ σ)} ≈≈wk ρ₁~~ρ₂ =
    ~~cong⟦≡⟧* σ ρ₁~~ρ₂
  ~~cong⟦⟧* {σ₁ = (t ∷ σ) ○ τ} ≈≈cons ρ₁~~ρ₂ =
    ~cong⟦≡⟧ t (~~cong⟦≡⟧* τ ρ₁~~ρ₂) ∷ ~~cong⟦≡⟧* σ (~~cong⟦≡⟧* τ ρ₁~~ρ₂)
  ~~cong⟦⟧* ≈≈id∷ (u₁~u₂ ∷ ρ₁~~ρ₂) =
    u₁~u₂ ∷ ρ₁~~ρ₂
